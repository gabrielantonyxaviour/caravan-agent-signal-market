...
| Public repo exists and mirrors hardening source | real | `gh repo view gabrielantonyxaviour/caravan-agent-signal-market` returned public repo; `git push origin main` pushed hardening commit `0795f2c` | No | Completed. |
